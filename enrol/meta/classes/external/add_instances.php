...
/**
 * External class for adding meta enrolment instances
 *
 * @package    enrol_meta
                ...
                new \external_single_structure(
                    [
                        ...
                        'creategroup' => new \external_value(PARAM_BOOL,
                            'Creates group in meta course named after linked course and puts all enrolled users in this group', VALUE_DEFAULT, false),
                    ]
    ...
    public static function execute(array $instances): array {
        ...
        foreach ($params['instances'] as $instance) {
            ...
            try {
                ...
                require_capability('moodle/course:enrolconfig', $contextmeta);
                require_capability('enrol/meta:config', $contextmeta);
            ...
            if ($instance['creategroup']) {
                try {
                    ...
                    throw new \invalid_parameter_exception(get_string('wscantcreategroup', 'enrol_meta', $instance['courseid']));
                }
            }
